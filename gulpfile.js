...
// Переименовываем файл src/main.html в запускающий 
// файл src/index.html (который используется локальным сервером)
...
// Для HTML отслеживаются все вложенные файлы, но
// функция html обрабатывает только первый уровень вложенности,
// а именно, только файл html_pages/main.html. Результат
// размещается в файле src/main.html (с удалёнными "../../")
